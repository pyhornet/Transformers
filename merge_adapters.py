...
model.add_weighted_adapter(["adapter1", "adapter2"], [1.0, 1.0], combination_type="my_merged_model", adapter_name="my_merged_model") # Refer to https://huggingface.co/docs/peft/package_reference/lora for more info
